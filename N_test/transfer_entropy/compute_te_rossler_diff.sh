#!/bin/bash
#SBATCH --job-name=TE_ros_diff_emb #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch compute_te_rossler_diff.sh ::: {0..25}

python3 compute_te_rossler_diff.py --seed ${1} --k 3 --minzero 0