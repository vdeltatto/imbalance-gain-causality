#!/bin/bash
#SBATCH --job-name=4minZ #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch generate_traj.sh ::: {0..19}
#python3 generate_traj.py --n_steps 1000000 --seed ${1} --sampling_stride 1000 # "small" taus (regular ones for three states)
python3 generate_traj.py --n_steps 2000000 --seed ${1} --sampling_stride 1000 # large taus (longer traj)