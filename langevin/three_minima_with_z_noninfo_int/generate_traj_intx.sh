#!/bin/bash
#SBATCH --job-name=int_x #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch generate_traj_intx.sh ::: {0..3} ::: 0 5 12
#python3 generate_traj_intx.py --n_steps 5 --seed ${1} --sampling_stride 1 --int_value ${2} # for debugging
python3 generate_traj_intx.py --n_steps 1000000 --seed ${1} --sampling_stride 1000 --int_value ${2}
