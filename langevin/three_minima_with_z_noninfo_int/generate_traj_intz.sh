#!/bin/bash
#SBATCH --job-name=intz2 #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch generate_traj_intz.sh ::: {0..3} ::: 0 5 16
python3 generate_traj_intz.py --n_steps 1000000 --seed ${1} --sampling_stride 1000 --int_value ${2}