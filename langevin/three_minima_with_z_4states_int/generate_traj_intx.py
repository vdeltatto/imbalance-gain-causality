...
def main():
    ...
    # save trajectory
    with open(f"./pickles_traj_intx/intvalue{args.int_value}_seed{args.seed}_N{args.N}_dt{args.dt}_samplingdt{args.sampling_stride}_nsteps{args.n_steps}_frict{args.friction}_temp{args.temperature}.p","wb") as f:
