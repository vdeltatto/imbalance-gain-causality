#!/bin/bash
#SBATCH --job-name=int_y #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch generate_traj_inty.sh ::: {0..3} ::: 0 5
#python3 generate_traj_inty.py --n_steps 5 --seed ${1} --sampling_stride 1 --int_value ${2} # for debugging
python3 generate_traj_inty.py --n_steps 2000000 --seed ${1} --sampling_stride 1000 --int_value ${2}