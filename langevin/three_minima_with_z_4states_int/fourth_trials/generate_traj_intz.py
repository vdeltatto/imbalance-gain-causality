...
def target_energy_python(states):
    ...
    gauss4 = 1/(2*np.pi)**(3/2) * torch.exp(-0.5*((states[0]-5)**2 + (states[1]-5)**2 + (states[2]-12)**2)) # (5,5,12)
...
def main():
    ...
    # initialize states
    weights = [1/3, 1/6, 1/3, 1/6]  # Mixture weights
    means = [[0, 0, 0], [5, 5, 0], [12, 0, 0], [5, 5, 12]]  # Means of the components
