...
sample_traj = pickle.load(open(f"../../fig3_errors/trajs/rossler_id/seed0_ieps0.p","rb"))
...
for ieps, eps in enumerate(epsilons):
    trajectory = pickle.load(open(f"../../fig3_errors/trajs/rossler_id/seed{args.seed}_ieps{ieps}.p","rb"))
...
pickle.dump(
    ...
    open(f"./pickles/rossler_id/seed{args.seed}_k{args.k}_minzero{bool(args.minzero)}.p","wb")
)