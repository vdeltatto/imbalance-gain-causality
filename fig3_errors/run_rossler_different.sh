...
#send using parallel sbatch run_rossler_different.sh ::: {0..25}
...
for ((i=0; i<${n_eps}; i++)); do
    ...
    python3 ../dynamical-systems/rossler_systems.py --seed ${1} --nsamples 205000 --epsilon ${eps} --omega_1 1.015 --omega_2 0.985 --output "./trajs/rossler_diff/seed${1}_ieps${i}.p"
done
