...
#send using parallel sbatch run_lorenz96.sh ::: {0..25}
...
for ((i=0; i<5; i++)); do
    ...
    python3 ../dynamical-systems/lorenz_96_systems.py --seed ${1} --nsamples 352500 --epsilon ${eps} --output "./trajs/lorenz96/seed${1}_ieps${i}.p"
done
