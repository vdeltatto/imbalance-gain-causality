...
#send using parallel sbatch run_lorenz_indep.sh ::: {0..25}
...
for ((i=0; i<${n_eps}; i++)); do
    ...
    python3 ../dynamical-systems/lorenz_systems.py --seed ${1} --epsilon_12 ${eps} --epsilon_21 0.1 --nsamples 305000 --output "./trajs/lorenz_indep/seed${1}_ieps${i}.p"
done
