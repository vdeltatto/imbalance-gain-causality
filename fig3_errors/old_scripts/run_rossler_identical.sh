...
#send using parallel sbatch run_rossler_identical.sh ::: {0..19}
...
for ((i=0; i<${n_eps}; i++)); do
    ...
    python3 ../dynamical-systems/rossler_systems.py --seed ${1} --epsilon ${eps} --omega_1 1.015 --omega_2 1.015 --output "./trajs/rossler_id/seed${1}_ieps${i}.p"
done
