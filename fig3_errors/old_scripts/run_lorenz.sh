...
#send using parallel sbatch run_lorenz.sh ::: {20..25}
...
for ((i=0; i<${n_eps}; i++)); do
    ...
    python3 ../dynamical-systems/lorenz_systems.py --seed ${1} --epsilon_12 ${eps} --epsilon_21 0.1 --output "./trajs/lorenz/seed${1}_ieps${i}.p"
done
