...
parser.add_argument("-tau_X0", "--tau_X0", dest="tau_X0",
                    default=0, type=int,
                    help="Artificial delay of X(0) signal")
...
taus = np.array([1, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 150, 200, 250, 300, 350, 400])
taus = np.append(-np.flip(taus),taus)
k = 20
E = 30
tau_e = 1
t0 = 500
...
X0 = trajectories[:,t0+args.tau_X0-E:t0+args.tau_X0, 1]
...
pickle.dump([taus, info_imbalances_X_to_Y], open(f"./pickles_{args.coupling}/XY{args.iY}_taux0{args.tau_X0}_seed{args.seed}.p","wb"))