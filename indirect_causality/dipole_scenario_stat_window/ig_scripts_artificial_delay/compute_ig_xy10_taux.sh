#!/bin/bash
#SBATCH --job-name=x10_taux #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch compute_ig_xy10_taux.sh ::: {0..30} ::: 10 30 50 70 90 110 130

python3 compute_ig.py --seed ${1} --coupling "noZ" --tau_X0 ${2} --iY 10