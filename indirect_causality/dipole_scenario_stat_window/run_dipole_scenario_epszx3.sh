...
#send using parallel sbatch run_dipole_scenario_epszx3.sh ::: {0..30}

seed=${1}
python3 ../../dynamical-systems/dipole_scenario_window_z.py --nsamples 2000 --epsilon_zx 3.0 --t0 1500 --tf 1530 --Fx 6 --Fz 5 --seed ${seed} --output_folder "./trajs_epszx_3/seed${seed}" 