...
#send using parallel sbatch run_rossler_fast_slow.sh ::: {0..25}
...
for tau in "${taus[@]}"
do
    python3 ../dynamical-systems/rossler_systems_fast_slow.py --seed ${1} --nsamples 205000 --epsilon 0.1 --omega_1 1.015 --omega_2 0.985 --tau ${tau} --output "./trajs/seed${1}_itau${itau}.p"
    ((itau++))
done
