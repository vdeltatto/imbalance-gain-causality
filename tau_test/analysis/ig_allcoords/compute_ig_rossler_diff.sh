#!/bin/bash
#SBATCH --job-name=tau_ros #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch compute_ig_rossler_diff.sh ::: 1 2 3 4 5 10 15 20 25 30 50 70 100 200 300 400 500 600 700 800 900 1000 1100 1200 1300 1400 1500

python3 compute_ig_rossler_diff.py --i_eps 14 --tau ${1}