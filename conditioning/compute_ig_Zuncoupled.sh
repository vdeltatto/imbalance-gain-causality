#!/bin/bash
#SBATCH --job-name=conf #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch compute_ig_Zuncoupled.sh ::: {0..25} ::: 'X->Y' 'Y->X'

python3 compute_ig_Zuncoupled.py --seed ${1} --case 'Zuncoupled' --direction ${2}