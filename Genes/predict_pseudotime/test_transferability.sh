#!/bin/bash
#SBATCH --job-name=transfer #name of job
#SBATCH --ntasks=1
...
python3 test_transferability.py --n_coords 30 --k 10 --n_best 20 --i_fold ${1}
#python3 test_transferability.py --n_coords 30 --k 1 --n_best 1 --i_fold ${1}