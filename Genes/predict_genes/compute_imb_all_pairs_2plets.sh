#!/bin/bash
#SBATCH --job-name=2plets #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch compute_imb_all_pairs_2plets.sh ::: {0..14}
python3 compute_imb_all_pairs_2plets.py --k 30 --i_parallel ${1}