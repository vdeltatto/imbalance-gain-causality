#!/bin/bash
#SBATCH --job-name=2plets_greedy #name of job
#SBATCH --ntasks=1
...
#send using parallel sbatch compute_imb_greedy_pairs_2plets_info_vs_noninfo.sh ::: {0..39}
python3 compute_imb_greedy_pairs_2plets_info_vs_noninfo.py --k 30 --i_parallel ${1}