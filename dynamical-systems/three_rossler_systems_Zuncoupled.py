...
def coupled_rossler_systems(t, xyz, omega_x, omega_y, omega_z, epsilon_xy):
    """
    ...
    y_dot_1 = -omega_y*y_2 - y_3 + epsilon_xy*(x_1 - y_1)
...
def jacobian(t, xyz, omega_x, omega_y, omega_z, epsilon_xy):
    x_1, x_2, x_3, y_1, y_2, y_3, z_1, z_2, z_3 = xyz
...
if __name__ == "__main__":
    ...
    parser.add_argument("-epsxy", "--epsilon_xy", dest="epsilon_xy",
    ...
    params = [args.omega_x, args.omega_y, args.omega_z, args.epsilon_xy]
