...
parser.add_argument("-o1", "--omega_1", dest = "omega_1", default = 1.015, 
                    type=float, help="Value of parameter omega for system X")
parser.add_argument("-o2", "--omega_2", dest = "omega_2", default = 0.985, 
                    type=float, help="Value of parameter omega for system Y")
parser.add_argument("-eps", "--epsilon", dest ="epsilon", default = 0.07, 
                    type=float, help="Value of the coupling parameter X->Y")
parser.add_argument("-nsamples", "--nsamples", dest ="nsamples", default = 105000, 
                    type=int, help="Number of samples of generated trajectory")
parser.add_argument("-dt", "--dt", dest ="dt", default = 0.0785, 
                    type=float, help="Integration time step")
parser.add_argument("-uf", "--undersample_factor", dest ="undersample_factor", default = 4, 
...
x0 = [11.120979, 17.496796, 51.023544]
...
# integrate equations
r = ode(coupled_rossler_systems, jacobian).set_integrator('dop853')
...
pickle.dump(trajectory, open("trajectory_rossler_systems.p","wb"))
