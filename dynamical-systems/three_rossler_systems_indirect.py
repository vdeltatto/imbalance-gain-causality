...
def coupled_rossler_systems(t, xyz, omega_x, omega_y, omega_z, epsilon_xz, epsilon_zy):
    """
    Three coupled Rossler systems, X->Z->Y (indirect causality X->Y)
    """
    x_1, x_2, x_3, y_1, y_2, y_3, z_1, z_2, z_3 = xyz

    x_dot_1 = -omega_x*x_2 - x_3
    ...
    z_dot_1 = -omega_z*z_2 - z_3 + epsilon_xz*(x_1 - z_1)
...
def jacobian(t, xyz, omega_x, omega_y, omega_z, epsilon_xz, epsilon_zy):
    x_1, x_2, x_3, y_1, y_2, y_3, z_1, z_2, z_3 = xyz

    return [[0., -omega_x, -1., 0., 0., 0., 0., 0., 0.],
            ...
            [epsilon_xz, 0., 0., 0., 0., 0., -epsilon_xz, -omega_z, -1.],
...
if __name__ == "__main__":
    ...
    parser.add_argument("-epsxz", "--epsilon_xz", dest="epsilon_xz",
                        default=0.08, type=float,
                        help="Value of the coupling parameter X->Z")
    ...
    params = [args.omega_x, args.omega_y, args.omega_z, args.epsilon_xz, args.epsilon_zy]
