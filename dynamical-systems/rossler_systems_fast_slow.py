...
def coupled_rossler_systems(t, xy, omega_1, omega_2, tau, epsilon):
    """
    Unidirectionally coupled Rossler systems X->Y
    """
    x_1, x_2, x_3, y_1, y_2, y_3 = xy

    x_dot_1 = 1/tau * (-omega_1*x_2 - x_3)
    x_dot_2 = 1/tau * (omega_1*x_1 + 0.15*x_2)
    x_dot_3 = 1/tau * (0.2 + x_3*(x_1-10.))
...
def jacobian(t, xy, omega_1, omega_2, tau, epsilon):
    x_1, x_2, x_3, y_1, y_2, y_3 = xy

    return [[0., -1/tau * omega_1, -1/tau, 0., 0., 0.],
            [1/tau * omega_1, 1/tau * 0.15, 0., 0., 0., 0.],
            [1/tau * x_3, 0., 1/tau * (x_1-10.), 0., 0., 0.],
...
if __name__ == "__main__":
    ...
    parser.add_argument("-tau", "--tau", dest="tau",
                        ...
                        help="Value of parameter tau for system X")
    ...
    params = [args.omega_1, args.omega_2, args.tau, args.epsilon]
